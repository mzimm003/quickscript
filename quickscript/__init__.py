"""
A simple module for enabling dynamic use of scripts by class or terminal command.
...
indented under an "Args:" section.

A run method must also be implemented, dictating how to use the arguments.

Finally, to allow for the terminal script choosing ability provided for by 
the ScriptChooser class, your script file should use 
